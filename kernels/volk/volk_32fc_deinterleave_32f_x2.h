...
static inline void
volk_32fc_deinterleave_32f_x2_rvv(float* iBuffer,
                                  float* qBuffer,
                                  const lv_32fc_t* complexVector,
                                  unsigned int num_points)
{
...
static inline void
volk_32fc_deinterleave_32f_x2_rvvseg(float* iBuffer,
                                     float* qBuffer,
                                     const lv_32fc_t* complexVector,
                                     unsigned int num_points)
{
    ...
    for (size_t vl; n > 0; n -= vl, complexVector += vl, iBuffer += vl, qBuffer += vl) {
        vl = __riscv_vsetvl_e32m4(n);
        vuint32m4x2_t vc = __riscv_vlseg2e32_v_u32m4x2((const uint32_t*)complexVector , vl);
