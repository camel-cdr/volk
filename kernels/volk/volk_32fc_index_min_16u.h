...
static inline void
volk_32fc_index_min_16u_rvv(uint16_t* target, const lv_32fc_t* source, uint32_t num_points)
{
...
static inline void
volk_32fc_index_min_16u_rvvseg(uint16_t* target, const lv_32fc_t* source, uint32_t num_points)
{
    vfloat32m4_t vmin = __riscv_vfmv_v_f_f32m4(FLT_MAX, __riscv_vsetvlmax_e32m4());
    vuint16m2_t vmini = __riscv_vmv_v_x_u16m2(0, __riscv_vsetvlmax_e16m2());
    vuint16m2_t vidx = __riscv_vid_v_u16m2(__riscv_vsetvlmax_e16m2());
