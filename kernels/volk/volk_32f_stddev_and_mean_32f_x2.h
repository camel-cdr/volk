...
static inline void
volk_32f_stddev_and_mean_32f_x2_rvv(float* stddev,
                                    float* mean,
                                    const float* inputBuffer,
                                    unsigned int num_points)
{
    ...
    vfloat32m2_t vsum2 = __riscv_vfadd(__riscv_vget_f32m2(vsum, 0),
                                       __riscv_vget_f32m2(vsum, 1), vl);
    vfloat32m2_t vfix2 = __riscv_vfsub(__riscv_vget_f32m2(vsum, 0),
                                       __riscv_vget_f32m2(vsum, 1), vl);
    vfix2 = __riscv_vfmul(vfix2, vfix2, vl);
    vfloat32m2_t vsumsq2 = __riscv_vfadd(__riscv_vget_f32m2(vsumsq, 0),
                                         __riscv_vget_f32m2(vsumsq, 1), vl);
    vsumsq2 = __riscv_vfmacc(vsumsq2, 0.5f / (num_points/vlmax), vfix2, vl);

    vl = __riscv_vsetvlmax_e32m1();
    vfloat32m1_t vsum1 = __riscv_vfadd(__riscv_vget_f32m1(vsum2, 0),
                                       __riscv_vget_f32m1(vsum2, 1), vl);
    vfloat32m1_t vfix1 = __riscv_vfsub(__riscv_vget_f32m1(vsum2, 0),
                                       __riscv_vget_f32m1(vsum2, 1), vl);
    vfix1 = __riscv_vfmul(vfix1, vfix1, vl);
    vfloat32m1_t vsumsq1 = __riscv_vfadd(__riscv_vget_f32m1(vsumsq2, 0),
                                         __riscv_vget_f32m1(vsumsq2, 1), vl);
