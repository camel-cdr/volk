...
static inline void
volk_32f_x2_pow_32f_rvv(float* cVector,
                        const float* bVector,
                        const float* aVector,
                        unsigned int num_points)
{
...
#error
    ...
    for (size_t vl; n > 0; n -= vl, aVector += vl, bVector += vl, cVector += vl) {
        ...
        vfloat32m1_t exp = __riscv_vfcvt_f(__riscv_vsub(
                 __riscv_vsra(__riscv_vreinterpret_i32m1(a), 23, vl), c127, vl), vl);
        vfloat32m1_t frac = __riscv_vreinterpret_f32m1(__riscv_vor(__riscv_vand(
                __riscv_vreinterpret_i32m1(va), m2, vl), m1, vl));
        ...
        vfloat32m1_t pow2n = __riscv_vreinterpret_f32m1(
                __riscv_vsll(__riscv_vadd(__riscv_vfcvt_rtz_x(fx, vl), c127, vl), 23, vl));
