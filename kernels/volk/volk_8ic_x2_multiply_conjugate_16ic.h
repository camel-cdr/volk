...
static inline void
volk_8ic_x2_multiply_conjugate_16ic_rvv(lv_16sc_t* cVector,
                                        const lv_8sc_t* aVector,
                                        const lv_8sc_t* bVector,
                                        unsigned int num_points)
{
    ...
    for (size_t vl; n > 0; n -= vl, aVector += vl, bVector += vl, cVector += vl) {
        ...
        vint16m4_t vi = __riscv_vsub(__riscv_vwmul(vai, vbr, vl), __riscv_vwmul(var, vbi, vl), vl);
...
static inline void
volk_8ic_x2_multiply_conjugate_16ic_rvvseg(lv_16sc_t* cVector,
                                           const lv_8sc_t* aVector,
                                           const lv_8sc_t* bVector,
                                           unsigned int num_points)
{
    ...
    for (size_t vl; n > 0; n -= vl, aVector += vl, bVector += vl, cVector += vl) {
        ...
        vint16m4_t vr = __riscv_vwmacc(__riscv_vwmul(var, vbr, vl), vai, vbi, vl);
        vint16m4_t vi = __riscv_vsub(__riscv_vwmul(vai, vbr, vl), __riscv_vwmul(var, vbi, vl), vl);
        __riscv_vsseg2e16_v_i16m4x2((int16_t*)cVector, __riscv_vcreate_v_i16m4x2(vr, vi), vl);
    }
}
