...
static inline void
volk_8u_x4_conv_k7_r2_8u_rvv(unsigned char* Y,
                             unsigned char* X,
                             unsigned char* syms,
                             unsigned char* dec,
                             unsigned int framebits,
                             ...
                             unsigned char* Branchtab)
{
    ...
    if (__riscv_vlenb() == 128/8) {
        vuint8m2_t vX0 = __riscv_vle8_v_u8m2(X, vl), vX1 = __riscv_vle8_v_u8m2(X+vl, vl);
        vuint8m2_t vY0 = __riscv_vle8_v_u8m2(Y, vl), vY1 = __riscv_vle8_v_u8m2(Y+vl, vl);
        ...
        for (size_t i = 0; i < n; ++i) {
            ...
            va = __riscv_vreinterpret_u8m2(__riscv_vsrl(__riscv_vreinterpret_u16m2(va), 2, vl/2));
            ...
            vuint16m4_t vX1ba = __riscv_vwmaccu(__riscv_vwaddu_vv(vX1b, vX1a, vl), 0xFF, vX1a, vl);
            vX1b = __riscv_vget_u8m2(__riscv_vreinterpret_u8m4(vX1ba), 0);
            vX1a = __riscv_vget_u8m2(__riscv_vreinterpret_u8m4(vX1ba), 1);

            vuint16m4_t vm = __riscv_vwmaccu(__riscv_vwaddu_vv(vY0, vY1, vl), 0xFF, vY1, vl);
            ...
            vmin = __riscv_vlmul_ext_u8m2(__riscv_vredminu(vmin, __riscv_vlmul_trunc_u8m1(vmin), vl));
            ...
            tmp = vX0; vX0 = vY0; vY0 = tmp;
            tmp = vX1; vX1 = vY1; vY1 = tmp;
        }
        if (n & 1) {
            __riscv_vse8(X, vY0, vl); __riscv_vse8(X+vl, vY1, vl);
            __riscv_vse8(Y, vX0, vl); __riscv_vse8(Y+vl, vX1, vl);
        } else {
            __riscv_vse8(X, vX0, vl); __riscv_vse8(X+vl, vX1, vl);
            __riscv_vse8(Y, vY0, vl); __riscv_vse8(Y+vl, vY1, vl);
        }
    } else if (__riscv_vlenb() == 256/8) {
        vuint8m1_t vX0 = __riscv_vle8_v_u8m1(X, vl), vX1 = __riscv_vle8_v_u8m1(X+vl, vl);
        vuint8m1_t vY0 = __riscv_vle8_v_u8m1(Y, vl), vY1 = __riscv_vle8_v_u8m1(Y+vl, vl);
        ...
        for (size_t i = 0; i < n; ++i) {
            ...
            va = __riscv_vreinterpret_u8m1(__riscv_vsrl(__riscv_vreinterpret_u16m1(va), 2, vl/2));
            va = __riscv_vand(va, v63, vl);
            ...
            vuint16m2_t vX1ba = __riscv_vwmaccu(__riscv_vwaddu_vv(vX1b, vX1a, vl), 0xFF, vX1a, vl);
            vX1b = __riscv_vget_u8m1(__riscv_vreinterpret_u8m2(vX1ba), 0);
            vX1a = __riscv_vget_u8m1(__riscv_vreinterpret_u8m2(vX1ba), 1);

            vuint16m2_t vm = __riscv_vwmaccu(__riscv_vwaddu_vv(vY0, vY1, vl), 0xFF, vY1, vl);
        ...
        vuint8mf2_t vX0 = __riscv_vle8_v_u8mf2(X, vl), vX1 = __riscv_vle8_v_u8mf2(X+vl, vl);
        ...
        for (size_t i = 0; i < n; ++i) {
            ...
            va = __riscv_vreinterpret_u8mf2(__riscv_vsrl(__riscv_vreinterpret_u16mf2(va), 2, vl/2));
            va = __riscv_vand(va, v63, vl);
            ...
            vuint8m1_t vX1ba = __riscv_vreinterpret_u8m1(__riscv_vwmaccu(
                    __riscv_vwaddu_vv(vX1b, vX1a, vl), 0xFF, vX1a, vl));
            vuint8m1_t vY01 = __riscv_vreinterpret_u8m1(__riscv_vwmaccu(
                    __riscv_vwaddu_vv(vY0, vY1, vl), 0xFF, vY1, vl));

            __riscv_vsm(&dec[8*i+0], __riscv_vmseq(vY01, vX1ba, vl*2), vl*2);

            // Renormalize
            vuint8m1_t vmin = __riscv_vrgather(__riscv_vredminu(vY01, vY01, vl*2), 0, vl*2);
