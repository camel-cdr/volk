...
static inline void
volk_16ic_deinterleave_16i_x2_rvv(int16_t* iBuffer,
                                  int16_t* qBuffer,
                                  const lv_16sc_t* complexVector,
                                  unsigned int num_points)
{
...
static inline void
volk_16ic_deinterleave_16i_x2_rvvseg(int16_t* iBuffer,
                                     int16_t* qBuffer,
                                     const lv_16sc_t* complexVector,
                                     unsigned int num_points)
{
    ...
    for (size_t vl; n > 0; n -= vl, complexVector += vl, iBuffer += vl, qBuffer += vl) {
        vl = __riscv_vsetvl_e16m4(n);
        vuint16m4x2_t vc = __riscv_vlseg2e16_v_u16m4x2((const uint16_t*)complexVector, vl);
