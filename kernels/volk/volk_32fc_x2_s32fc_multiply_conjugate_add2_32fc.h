...
volk_32fc_x2_s32fc_multiply_conjugate_add2_32fc_rvv(lv_32fc_t* cVector,
                                                    ...
                                                    unsigned int num_points)
{
    vfloat32m2_t vbr = __riscv_vfmv_v_f_f32m2(lv_creal(*scalar), __riscv_vsetvlmax_e32m2());
    vfloat32m2_t vbi = __riscv_vfmv_v_f_f32m2(lv_cimag(*scalar), __riscv_vsetvlmax_e32m2());
    size_t n = num_points;
    for (size_t vl; n > 0; n -= vl, bVector += vl, aVector += vl, cVector += vl) {
        ...
        vuint64m4_t v = __riscv_vwmaccu(__riscv_vwaddu_vv(vru, viu, vl), 0xFFFFFFFF, viu, vl);
...
volk_32fc_x2_s32fc_multiply_conjugate_add2_32fc_rvvseg(lv_32fc_t* cVector,
                                                       ...
                                                       unsigned int num_points)
{
    vfloat32m4_t vbr = __riscv_vfmv_v_f_f32m4(lv_creal(*scalar), __riscv_vsetvlmax_e32m4());
